...
function App() {
  ...
  // Using a direct image URL that's more reliable for face detection
  const referenceImage = 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&fit=crop';
  ...
  const compareFaces = async () => {
    if (!webcamRef.current || !isModelLoaded || imageError) return;
          ...
          <div className="mt-6 flex flex-col items-center gap-4">
            ...
            {imageError && (
              <div className="text-red-500">
                Error loading reference image. Please check the image URL.
              </div>
            )}

            {matchResult !== null && !isLoading && !imageError && (
